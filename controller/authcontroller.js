        ...
        const result = await user.save((err, user)=>{ 
            if(err){
                return res.status(400).json({
                    err: "something wrong with the details provided. "
                });
            }
...
exports.signin = async (req,res)=>{
    try{
        ...
        const token = jwt.sign({_id: validUser._id}, "516ff6f7349e9ff70daf55911b02dc5d9a4669c2721ac68f6e7b9c383fa4e2ed6197bfeb837444656534501831e574aaa62370d70b7a0cf0d6aef4e20dff74d5" );
